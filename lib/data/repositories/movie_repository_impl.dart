...
class MovieRepositoryImpl implements MovieRepository {
  ...
  @override
  Future<Either<Failure, List<Movie>>> getAiringTodayTv() async {
    try {
  ...
  @override
  Future<Either<Failure, List<Movie>>> getWatchlistMovies(String kind) async {
    final result = await localDataSource.getWatchlistMovies(kind);
