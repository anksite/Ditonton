...
class MockGetWatchlistMovies extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.Movie>>> execute(String? kind) =>
      (super.noSuchMethod(Invocation.method(#execute, [kind]),
              returnValue:
                  _i4.Future<_i2.Either<_i5.Failure, List<_i6.Movie>>>.value(
                      _FakeEither_0<_i5.Failure, List<_i6.Movie>>(
                          this, Invocation.method(#execute, [kind]))))
