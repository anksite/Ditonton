...
void main() {
  ...
  final tMovieModelTv = MovieModel(
    adult: false,
  ...
  final tMovieModelListTv = <MovieModel>[tMovieModelTv];
  ...
  group('Airing Today TV', () {
    test(
      ...
      when(mockRemoteDataSource.getAiringTodayTv())
          .thenAnswer((_) async => tMovieModelListTv);
      // act
      ...
      /* workaround to test List in Right. Issue: https://github.com/spebbe/dartz/issues/80 */
      final resultList = result.getOrElse(() => []);
      expect(resultList, tMovieListTv);
    });
  ...
  group('get watchlist movies', () {
    test('should return list of Movies', () async {
      // arrange
      when(mockLocalDataSource.getWatchlistMovies(MOVIE))
          .thenAnswer((_) async => [testMovieTable]);
      // act
      final result = await repository.getWatchlistMovies(MOVIE);
      // assert
      final resultList = result.getOrElse(() => []);
